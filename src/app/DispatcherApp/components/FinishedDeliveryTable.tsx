...
import { getFinishedDeliveries, getCustomers, getDeliverers } from "../state";
...
const FinishedDeliveryTable = (): JSX.Element => {
    ...
    <Row>
      <Col classes="mb-3">
        ...
        <MaterialTable
          ...
          data={useAppSelector(getFinishedDeliveries) ?? []}
          icons={tableIcons}
          options={{
            paging: true,
...
// export default connect(mapStateToProps)(FinishedDeliveryTable);
export default FinishedDeliveryTable;
